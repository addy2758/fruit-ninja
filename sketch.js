  ...
  if(World.frameCount%80===0){ 
   ...
   fruit.scale=0.2;
    ...
    r=Math.round(random(1,4)); 
     ...
     fruit.velocityX=Math.round(random(-10,-20));
...
function Enemys() {
   ...
   if(World.frameCount%200 === 0) { 
     ...
     monster.velocityX=Math.round(random(-10,-20));
   ...
   if(World.frameCount%300 === 0) {
     ...
     monster2=createSprite(600,200,20,20);
     monster2.addImage("moving2", monsterImage2);
     monster2.y=Math.round(random(20,580));
     monster2.velocityX=Math.round(random(-10,-20));
